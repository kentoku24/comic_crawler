...
| 12.4 `fetch` | `TC-FETCH-03` | `tests.test_runner.RunnerTests.test_run_coordinator_queues_startup_while_fetch_is_in_progress`; `tests.test_runner.RunnerTests.test_run_coordinator_queues_scheduled_while_fetch_is_in_progress` |
| 12.4 `fetch` | `TC-FETCH-04` | `TBD (spec changed to reject concurrent fetch; implementation/tests not yet updated)` |
...
| 12.6 Delivery visibility | `TC-DELIVERY-01` | `tests.test_runner.RunnerTests.test_run_once_reports_daily_pending_and_delivery_failure_visibility` |
| 12.6 Delivery visibility | `TC-DELIVERY-02` | `TBD (spec changed to best-effort delivery; implementation/tests not yet updated)` |
