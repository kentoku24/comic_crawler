...
.venv/bin/python scripts/run_mocked_acceptance.py
```
...
- canonical docs の mocked acceptance 契約をまとめて確認したいときは `.venv/bin/python scripts/run_mocked_acceptance.py` を使う
